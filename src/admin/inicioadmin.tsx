    ...
    <>
      ...
      <div className="min-h-screen bg-gray-100">
        <div className="text-center py-10">
          <h1 className="text-4xl font-bold text-gray-800">Bienvenido Administrador</h1>
          <p className="mt-4 text-lg text-gray-600">Estas son tus gestiones para revisar</p>
        </div>
